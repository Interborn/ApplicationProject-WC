...
const benefitIndex = [
  {
    ...
    body: 'Encourage early booking with the personalized booking environment created by Calendio. Our appointment booking software easily integrates with your website, making it a stress-free online booking experience for your client.',
    image: '/benefit-1.png',
  },
  {
    class: 'benefit-2',
    title: 'Appointment reminders for all participants',
    body: 'No more forgotten appointments. Our scheduling software will automatically send email and SMS notifications so that both the staff and the customers receive appointment reminders and updates.',
    image: '/benefit-2.png',
  },
  {
    class: 'benefit-3',
    title: 'Monitor your business performance',
    body: 'The Calendio online booking system helps you increase sales by providing important business reports and dashboards to help you track the performance of your business through vital KPIs and statistics.',
    image: '/benefit-3.png',
  },
];
...
const Benefits = () => {
  ...
  useEffect(() => {
    ...
    benefits.forEach((benefit, index) => {
      ...
      benefit.setAttribute('data-index', index);
    });
